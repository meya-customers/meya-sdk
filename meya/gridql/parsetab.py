...
_lr_action_items = {
    ...
    "$end": (
        [1, 2, 8, 9, 10, 11, 12, 15, 16, 17, 18, 24, 25, 26, 27, 28, 30, 32],
        [
            0,
            -7,
            -17,
    ...
    "RPAREN": (
        [2, 8, 9, 10, 11, 12, 15, 16, 17, 18, 19, 24, 25, 26, 27, 28, 30, 32],
        [
            -7,
            -17,
            -14,
...
_lr_goto_items = {
    "expression": (
        [0, 1, 6, 12, 13, 14, 19, 26, 27],
        [1, 12, 19, 12, 26, 27, 12, 12, 12],
    ),
    "unary_expression": (
        [0, 1, 3, 4, 5, 6, 12, 13, 14, 19, 23, 26, 27],
        [2, 2, 16, 17, 18, 2, 2, 2, 2, 2, 30, 2, 2],
    ),
    "phrase_or_term": ([7, 29], [20, 31]),
}
